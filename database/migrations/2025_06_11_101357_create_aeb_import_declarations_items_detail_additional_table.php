...
return new class extends Migration
{
    ...
    {
        Schema::create('aeb_import_declarations_items_detail_additional', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('aeb_import_declarations_items_detail_additional');
    }
};
